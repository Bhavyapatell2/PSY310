...
expName = 'adaptivestaricase'  # from the Builder filename that created this script
...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='C:\\Users\\Bhavya\\OneDrive\\Desktop\\Lab In Psych\\psychopy final\\tutorial 3\\adaptivestaricase_lastrun.py',

...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='C:\\Users\\Bhavya\\OneDrive\\Desktop\\Lab In Psych\\psychopy final\\tutorial 8\\intentional_binding_lastrun.py',
...
def run(expInfo, thisExp, win, globalClock=None, thisSession=None):
    ...
    trials = data.TrialHandler(nReps=34.0, method='random', 
        ...
        trialList=data.importConditions('C:/Users/Bhavya/Downloads/ibs_cond.xlsx'),
